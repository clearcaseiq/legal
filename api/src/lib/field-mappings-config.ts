  ...
  mappings: [
    {
      ...
      entries: [
        ...
        { canonical: 'catastrophic', label: 'Catastrophic Injury', aliases: ['catastrophic_injury'] },
        { canonical: 'high_severity_surgery', label: 'High-Severity / Surgery', aliases: [] },
        { canonical: 'other', label: 'Other Personal Injury', aliases: ['general_pi', 'personal_injury'] },
      ],
    },
  ],
}
