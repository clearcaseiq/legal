/**
 * Modal to add a case contact (person associated with a case).
 */
...
interface Lead {
  id: string
  assessment?: { claimType?: string; venueCounty?: string; venueState?: string; user?: { firstName?: string; lastName?: string } }
}
      ...
      <div className="relative bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <div>
            ...
            {lead && <p className="text-sm text-gray-500 mt-0.5">{caseLabel}</p>}
          </div>
