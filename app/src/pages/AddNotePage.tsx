/**
 * Add note page - dedicated screen for adding a note to a case (not post-acceptance).
 */
import { useState, useEffect } from 'react'
import { useParams, useNavigate } from 'react-router-dom'
import { ArrowLeft } from 'lucide-react'
import { getLead, createLeadNote } from '../lib/api'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Add note</h1>
